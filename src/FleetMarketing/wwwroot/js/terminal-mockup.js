...
(function () {
    ...
    async function scene2() {
        ...
        row1.innerHTML = '<span><span class="status-dot working"></span><span class="agent-name">main</span></span><span class="agent-state">working</span>';
        ...
        row2.innerHTML = '<span><span class="status-dot working"></span><span class="agent-name">sub-orchestrator #2</span></span><span class="agent-state">working</span>';
        right.appendChild(row2);
        await wait(reduceMotion ? 400 : 1800);

        row2.innerHTML = '<span><span class="status-dot done"></span><span class="agent-name">sub-orchestrator #2</span></span><span class="agent-state">done</span>';
